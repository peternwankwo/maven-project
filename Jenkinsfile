            ...
            parallel{
                stage ('Deploy to Staging'){
                    steps {
						...
						bat "ssh -v -o StrictHostKeyChecking=no -i D:/tomcat/tomcat-demo.pem ec2-user@${params.tomcat_prod} mkdir -p /var/lib/tomcat7/webapp && sudo mv /tmp/*.war /var/lib/tomcat7/webapp"
